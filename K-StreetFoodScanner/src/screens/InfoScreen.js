...
const InfoScreen = () => {
  ...
  const gemini = async (name) => {
    ...
    const res = await model.generateContent("Describe me about " + name + " with it's ingredients listed and inform me any allergic ingredients in it.");
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text style={{ textAlign: "center", color: "#f72900" }}>{"\n"}This information was generated by AI. It may contain wrong information{"\n"}</Text>
      </View>
    </ScrollView>
  );
};
